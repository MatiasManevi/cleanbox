...
<!--<link rel="stylesheet" href="<?php echo base_url() ?>plugins/bootstrap-3.1.1-dist/css/bootstrap-theme.css?<?php echo filemtime('plugins/bootstrap-3.1.1-dist/css/bootstrap-theme.css') ?>"/>
<link rel="stylesheet" href="<?php echo base_url() ?>plugins/bootstrap-3.1.1-dist/css/bootstrap-theme.min.css?<?php echo filemtime('plugins/bootstrap-3.1.1-dist/css/bootstrap-theme.min.css') ?>"/>-->
...
<script type="text/javascript" src="<?php echo asset_url() ?>js/cookie.js?<?php echo filemtime('application/assets/js/cookie.js') ?>"></script>
<script type="text/javascript" src="<?php echo asset_url() ?>js/modals.js?<?php echo filemtime('application/assets/js/modals.js') ?>"></script>
...
<script>
    ...
    var search_all_of_id = '<?php echo site_url('manager/searchAllOfId'); ?>';
    var refresh_list = '<?php echo site_url('manager/refresh'); ?>';
    var load_entity_to_edit = '<?php echo site_url('manager/loadEntityToEdit') ?>';
    var delete_entity = '<?php echo site_url('manager/deleteEntity') ?>';
