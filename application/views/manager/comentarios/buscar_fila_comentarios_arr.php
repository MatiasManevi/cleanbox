        ...
        <table class="table table-hover">
            ...
            if (count($comentarios) > 0) {
                for ($x = 0; $x < count($comentarios); $x++) {
                    echo '<tr class="reg_' . $comentarios[$x]['com_id'] . '">';
                    echo '<td style="text-align: center !important;">' . $comentarios[$x]['com_prop'] . '</td>';
                    echo '<td style="text-align: center !important;">' . $comentarios[$x]['com_date'] . '</td>';
                    echo '<td style="text-align: center !important;">' . substr($comentarios[$x]['com_com'], 0, 90) . ' [...]</td>';
                    echo '<td style="text-align: center !important;">' . $comentarios[$x]['com_dom'] . '</td>';
                    echo '<td>';
                    echo '<a style="text-align: center !important;" href="javascript:;" class="glyphicon glyphicon-edit" onclick="load_edit(\'' . site_url('manager/load_edit_comentarios/' . $comentarios[$x]['com_id']) . '\')"></a> | ';
                    echo '<a style="text-align: center !important;" href="javascript:;" class="glyphicon glyphicon-trash" onclick="del(\'' . $comentarios[$x]['com_id'] . '\',\'' . site_url('manager/del_comentarios/' . $comentarios[$x]['com_id']) . '\')"></a>  ';
                    echo '</tr>';
                }
            } else {
