...
<h1 style="font-size: 18px;">Listado de transacciones de tipo Bancarias en un rango de fechas determinado</h1>
...
<script>
    $("#buttons_cli").click(function() {
        var desde = $('#d').val();
        var hasta = $('#h').val();     
       request_informe('<?= site_url() . 'informar_bancarias/' ?>'+desde+'/'+hasta,'','.contenedor_centro');
    });
    $( "#d" ).datepicker({
