...
<h1 style="font-size: 18px;">Informe Diario detallado de los movimientos en la Caja</h1>
...
<script>
    $("#buttons_cli").click(function() {
        var fecha = $('#fecha').val();    
        request_informe('<?= site_url() . 'informar_caja_detallada/' ?>'+fecha,'','.contenedor_centro');
    });
    var date_opt = {
