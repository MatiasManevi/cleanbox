...
<h1 style="font-size: 18px;">Informe de inquilinos morosos al dia de la Fecha</h1>
<input readonly="true" id="fecha" type="text" name="fecha" class="form-control ui-autocomplete-input" placeholder="Fecha" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true" style="cursor: pointer;margin-top: 31px;clear: both;margin-bottom: 5px;margin-right: 5px;font-size: 16px;width: 400px;float: left;">         
...
<script>
    $("#buttons_cli").click(function() {
        var fecha = $('#fecha').val();    
        request_informe('<?= site_url() . 'informar_morosos/' ?>'+fecha,'','.contenedor_centro');
    });
    var date_opt = {
