...
<h1 style="font-size: 18px;">Informe de aquellos propietarios los cuales no retiraron Rendiciones en un periodo determinado</h1>
...
<script>
    $("#buttons_cli").click(function() {
        var desde = $('#d').val();
        var hasta = $('#h').val();  
       request_informe('<?= site_url() . 'informar_pendientes/' ?>'+desde+'/'+hasta,'','.contenedor_centro');
    });
    $( "#d" ).datepicker({
