...
<h1 style="font-size: 18px;">Informe del porcentaje de rendiciones efectuadas en un periodo determinado</h1>
...
<script>
    $("#buttons_cli").click(function() {
        var desde = $('#d').val();
        var hasta = $('#h').val();  
       request_informe('<?= site_url() . 'informar_porcentaje/' ?>'+desde+'/'+hasta,'','.contenedor_centro');
    });
    $( "#d" ).datepicker({
