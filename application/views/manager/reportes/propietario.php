...
<h1 style="font-size: 18px;">Informe de los movimientos de la cta. cte. de un Propietario en un rango de fechas determinado</h1>
<div style="margin-top: 30px">
    ...
    <input value="" id="cuentas" type="text" name="fecha" class="form-control ui-autocomplete-input" placeholder="Propietario" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true" style="margin-bottom: 5px;margin-right: 5px;font-size: 16px;width: 400px;float: left;">         
...
<script>
    $("#buttons_cli").click(function() {
       ...
       request_informe('<?= site_url() . 'informar_prop/' ?>'+desde+'/'+hasta+'/'+cuenta,'','.contenedor_centro');
    });
    $( "#d" ).datepicker({
