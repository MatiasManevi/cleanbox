...
<h1 style="font-size: 18px;">Lista de las ctas. ctes. de los propietarios y sus Rendiciones en un rango de fecha determinado</h1>
...
<script>
    $("#buttons_cli").click(function() {
        var desde = $('#d').val();
        var hasta = $('#h').val();     
       request_informe('<?= site_url() . 'informar_cobros/' ?>'+desde+'/'+hasta,'','.contenedor_centro');
    });
    $( "#d" ).datepicker({
