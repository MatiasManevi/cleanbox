...
<h1 style="font-size: 18px;">Listado de los prestamos de la cta. cte. de la Inmobiliaria a cuentas corrientes de propietarios en un rango de fechas determinado</h1>
...
<script>
    $("#buttons_cli").click(function() {
        var desde = $('#d').val();
        var hasta = $('#h').val();     
        request_informe('<?= site_url() . 'informar_prestamos/' ?>'+desde+'/'+hasta,'','.contenedor_centro');
    });
    $( "#d" ).datepicker({
