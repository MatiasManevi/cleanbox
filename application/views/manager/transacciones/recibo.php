            ...
            <div class="a" style="float:none !important;margin-top:-65px;">
                ...
                for ($x = 0; $x < count($creditos_recibo_alquiler); $x++) {
                    ...
                    ?> en concepto de pago de <?= $creditos_recibo_alquiler[$x]['cred_concepto'] ?> y Gastos correspondiente al mes 
                            ...
                            $neto = $creditos_recibo_alquiler[$x]['cred_iva_comi'] + $creditos_recibo_alquiler[$x]['cred_iva_alq'] + $creditos_recibo_alquiler[$x]['cred_neto_a_cobrar'];
                            $pagado_cheque = $creditos_recibo_alquiler[$x]['cred_interes_calculados'] + $creditos_recibo_alquiler[$x]['cred_iva_comi'] + $creditos_recibo_alquiler[$x]['cred_iva_alq'] + $creditos_recibo_alquiler[$x]['cred_monto'];
                            $pagado_efectivo = $pagado_cheque;
                            $adeuda = $neto - $pagado_efectivo;
                            ?>
                            <div class="leyenda">
                                ...
                                <div class="item_locador">Efectivo.......: $ <?= $creditos_recibo_alquiler[$x]['cred_forma'] == 'Efectivo' ? $pagado_efectivo : 0.00 ?></div>
                                ...
                                <div style="widht:250px !important;" class="item_locador">Cheque..: $ <?= $creditos_recibo_alquiler[$x]['cred_forma'] == 'Efectivo' ? 0.00 : $pagado_cheque . ' N° ' . $creditos_recibo_alquiler[$x]['cred_nro_cheque'] . ' ' . $creditos_recibo_alquiler[$x]['cred_banco'] ?></div>
