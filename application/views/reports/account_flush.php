<div class="section">
    <div class="section_description">
        <label>Informe de balance de cuentas en un periodo determinado</label>
    </div>

    <form class="section_form" action="javascript:;" onsubmit="report.buildReport('<?php echo site_url('buildAccountFlushReport') ?>', this);return false;" enctype="multipart/form-data"> 
