<div class="section">
    <div class="section_description">
        <label>Listado general de los creditos y debitos percibidos en cada concepto, en un rango de fechas determinado</label>
    </div>

    <form class="section_form" action="javascript:;" onsubmit="report.buildReport('<?php echo site_url('buildAllConceptsMovementsReport') ?>', this);return false;" enctype="multipart/form-data"> 
