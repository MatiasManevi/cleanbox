<div class="section">
    <div class="section_description">
        <label>Listado de transacciones de tipo Bancarias en un rango de fechas determinado</label>
    </div>

    <form class="section_form" action="javascript:;" onsubmit="report.buildReport('<?php echo site_url('buildBankTransactionsReport') ?>', this);return false;" enctype="multipart/form-data"> 
