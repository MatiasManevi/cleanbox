<div class="section">
    <div class="section_description">
        <label>Informe que lista todas las transacciones que se realizaron el mes ingresado pero que son de otro mes</label>
    </div>

    <form class="section_form" action="javascript:;" onsubmit="report.buildReport('<?php echo site_url('buildOutmonthTransactionsReport') ?>', this);return false;" enctype="multipart/form-data"> 
