<div class="section">
    <div class="section_description">
        <label>Listado de los prestamos de la cta. cte. de la Inmobiliaria a cuentas corrientes de propietarios en un rango de fechas determinado</label>
    </div>

    <form class="section_form" action="javascript:;" onsubmit="report.buildReport('<?php echo site_url('buildpropietaryLoansReport') ?>', this);return false;" enctype="multipart/form-data"> 
