...
CREATE TABLE `caja`.`settings` ( `id` INT NOT NULL AUTO_INCREMENT , `iibb_bank_tax` DECIMAL(10,2) NOT NULL , `iva_tax` DECIMAL(10,2) NOT NULL , `begin_cash_zero` TINYINT NOT NULL , `code_control` TINYINT NOT NULL , `logo` VARCHAR(255) NOT NULL , `cuit` VARCHAR(255) NOT NULL , `iibb_number` VARCHAR(255) NOT NULL , `user_id` INT NOT NULL , `init_activity_date` VARCHAR(255) NOT NULL , `email` VARCHAR(255) NOT NULL , `address` VARCHAR(255) NOT NULL , `activity` VARCHAR(556) NOT NULL , `cel_phone` VARCHAR(255) NOT NULL , `phone` VARCHAR(255) NOT NULL , `site_url` VARCHAR(255) NOT NULL , `fiscal_status` VARCHAR(255) NOT NULL , `name` VARCHAR(556) NOT NULL , `zip_code` VARCHAR(255) NOT NULL , `city` VARCHAR(255) NOT NULL , `state` VARCHAR(255) NOT NULL , PRIMARY KEY (`id`) );
ALTER TABLE `settings` CHANGE `iibb_bank_tax` `iibb_bank_tax` VARCHAR(255) NOT NULL, CHANGE `iva_tax` `iva_tax` VARCHAR(255) NOT NULL;

INSERT INTO `caja`.`settings` (`id`, `iibb_bank_tax`, `iva_tax`, `begin_cash_zero`, `code_control`, `logo`, `cuit`, `iibb_number`, `user_id`, `init_activity_date`, `email`, `address`, `activity`, `cel_phone`, `phone`, `site_url`, `fiscal_status`, `name`, `zip_code`, `city`, `state`) VALUES (NULL, '0.0245', '0.21', '0', '0', '', '20-07583942-2', '20-07583942-2', '1', '20-05-74', 'info@andresdavinia.com.ar', 'SANTIAGO DEL ESTERO 1477', 'Compras-Ventas-Administracion de Propiedades-Alquileres-Tasaciones-Remates-Loteos', '154334168', '0376-4425983', 'www.andresdavinia.com.ar', 'I.V.A RESPONSABLE INSCRIPTO', 'Andres Davinia Inmobiliaria', '3300', 'Posadas', 'Misiones');
...
CREATE TABLE `caja`.`services_control` ( `id` INT NOT NULL AUTO_INCREMENT , `service` VARCHAR(255) NOT NULL , `contract` INT NOT NULL , `date` VARCHAR(255) NOT NULL , `month_checked` VARCHAR(255) NOT NULL , PRIMARY KEY (`id`) );
